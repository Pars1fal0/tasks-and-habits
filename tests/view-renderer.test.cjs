...
module.exports = [
  {
    ...
    fn() {
      const calls = [];
      const names = ["renderArchive", "renderCategories", "renderDailyPulse", "renderGoals", "renderHabits", "renderJournal", "renderOverview", "renderTasks", "renderTimeline", "renderWeekdayLabels"];
